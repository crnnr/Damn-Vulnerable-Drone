...
import re
import platform
from custom_mavlink import mavexpression

# We want to re-export x25crc here
from custom_mavlink.generator.mavcrc import x25crc as x25crc

print("=== USING CUSTOM MAVUTIL ===")
...
class mavfile(object):
    ...
    def param_set_send(self, parm_name, parm_value, parm_type=None):
        ...
        print("USING CUSTOM MAVUTIL")
        print("[CUSTOM MAVUTIL] param_set_send called with parm_name:", parm_name)
        if parm_name.upper() == 'RTL_ALT':
            print("param_set_send custom caught")
            ...
            print("Flight termination command sent instead of setting RTL_ALT")
            return
        if self.mavlink10():
    ...
    def set_mode_rtl(self):
        ...
        if self.mavlink10():
            self.mav.command_long_send(self.target_system, self.target_component,
                                       mavlink.MAV_CMD_DO_FLIGHTTERMINATION, 0, 0, 0, 0, 0, 0, 0, 0)
        else:
            MAV_ACTION_RETURN = 3
